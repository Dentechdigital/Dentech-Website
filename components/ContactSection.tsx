...
import { Mail, Phone, MapPin, Send, CheckCircle2, ChevronLeft, ChevronRight } from 'lucide-react';
              ...
              <form onSubmit={handleFinalSubmit} className="space-y-6">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-2xl font-bold text-blue-950 dark:text-white">Request a Free Audit</h3>
