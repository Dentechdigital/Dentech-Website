...
export default function SpecialOfferCTA() {
  return (
    <section className="relative overflow-hidden py-20">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-blue-50/70 dark:from-slate-950 dark:via-slate-950 dark:to-blue-950/50" />
      <div className="pointer-events-none absolute -top-28 left-1/4 h-72 w-72 rounded-full bg-blue-200/40 blur-3xl dark:bg-blue-500/20" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid overflow-hidden rounded-[2rem] border border-slate-200/70 bg-white/95 shadow-[0_30px_90px_rgba(30,64,175,0.14)] dark:border-slate-800 dark:bg-slate-900/90 lg:grid-cols-[1.02fr_0.98fr]">
          ...
          <div className="relative flex min-h-[350px] items-end justify-center bg-gradient-to-b from-blue-50/70 via-blue-50/30 to-transparent px-4 pt-8 sm:px-8 lg:min-h-[430px] lg:px-10 dark:from-blue-950/30 dark:via-blue-950/10">
            ...
            <img
              ...
              className="m-0 -mb-8 block w-full max-w-[44rem] object-contain object-bottom p-0 drop-shadow-[0_24px_40px_rgba(15,23,42,0.16)] lg:-mb-10"
            />
          </div>
        </div>
      </div>
