    ...
    >
      ...
      <div className="mt-3 space-y-2">
        <button
          ...
          className="w-full rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-3 py-2 text-sm font-semibold text-white transition-[transform,filter,background] duration-120 ease-out will-change-transform hover:-translate-y-0.5 hover:from-blue-700 hover:to-indigo-700 hover:brightness-105 active:translate-y-0 active:scale-[0.99]"
        >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-100 px-3 py-2 text-sm font-medium text-slate-700 transition-[transform,background] duration-120 ease-out will-change-transform hover:-translate-y-0.5 hover:bg-slate-200 active:translate-y-0 active:scale-[0.99] dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
        >
          <Search size={14} />
