      ...
      <div className="dchat-scrollbar-none flex gap-2 overflow-x-auto whitespace-nowrap pb-1 pr-1">
        {prompts.slice(0, 6).map((prompt) => (
          <button
            ...
            className="dchat-bubble-enter shrink-0 rounded-full border border-blue-100 bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-800 transition duration-200 hover:border-blue-300 hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-60 dark:border-blue-900/60 dark:bg-blue-950/40 dark:text-blue-200"
          >
            {prompt}
          </button>
        ))}
