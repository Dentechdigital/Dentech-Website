...
import { MARKETING_RETAINER_TIERS, RETAINER_WHAT_TO_EXPECT } from '../marketingRetainerContent';
    ...
    >
      ...
      <div className="relative z-10 lp-shell">
        ...
        <p className="mt-3 max-w-3xl text-slate-600">
          Sign a{' '}
          <strong className="font-medium text-blue-950">6-month growth marketing contract</strong> and we design and
          launch your starter clinic website at <strong className="font-medium text-blue-950">no separate build fee</strong>.
          The retainer itself is a scoped program focused on visibility, leads, and conversion — typically across SEO/GEO,
          social consistency, paid media (by tier), and reporting. Exact deliverables and fees are spelled out in your
          contract before you commit.
        </p>
        <p className="mt-4 max-w-3xl text-sm leading-relaxed text-slate-600">
          Monthly marketing aligns with our{' '}
          <strong className="font-medium text-blue-950">Starter, Signature, and Elite</strong> programs on the main
          site.{' '}
          <a
            href={pricingHref}
          ...
          {MARKETING_RETAINER_TIERS.map((tier) => (
            <li
              ...
              className={`relative flex flex-col rounded-2xl border p-6 shadow-sm ${
                tier.highlighted
                  ? 'border-blue-300 bg-gradient-to-b from-blue-50/90 to-white ring-1 ring-blue-200/80'
        ...
        <div className="mt-12 rounded-2xl border border-slate-200 bg-slate-50/80 p-6 sm:p-8">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-600">
            From application to renewal, the path matches how we run engagements on the main site — clear scope up front,
            then execution and reporting through the six-month term.
          </p>
